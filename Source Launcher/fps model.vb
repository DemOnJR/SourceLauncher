Public NotInheritable Class ButtonFPSModels
    ...
    Private Sub NsButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BUTONYES.Click

        'asta va fi local 2 (nu e gata)

        Dim FileToDelete As String

        FileToDelete = "classic.zanyx"
        ...
        Dim filepath As String = "fps.zanyx"
        If Not System.IO.File.Exists(filepath) Then
            System.IO.File.Create(filepath).Dispose()
        End If

        LauncherStart.wpn.ForeColor = Color.ForestGreen
        LauncherStart.wpn.Text = ("Weapons Models : FPS")
        ...
        If My.Computer.FileSystem.FileExists("cstrike/CheckLicense.dll") Then
            If My.Computer.FileSystem.FileExists("cstrike/models/player.mdl") Then
                MsgBox("Please wait... downloading FPS Models", MsgBoxStyle.Information, "Downloading")
                ...
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_ak47.mdl", upa3)
                My.Computer.FileSystem.DeleteFile(upa4)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_ak47.mdl", upa4)
                My.Computer.FileSystem.DeleteFile(upa5)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_ak47.mdl", upa5)

                My.Computer.FileSystem.DeleteFile(upa6)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_m4a1.mdl", upa6)
                My.Computer.FileSystem.DeleteFile(upa7)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_m4a1.mdl", upa7)
                My.Computer.FileSystem.DeleteFile(upa8)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_m4a1.mdl", upa8)

                My.Computer.FileSystem.DeleteFile(upa12)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_awp.mdl", upa12)
                My.Computer.FileSystem.DeleteFile(upa13)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_awp.mdl", upa13)
                My.Computer.FileSystem.DeleteFile(upa14)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_awp.mdl", upa14)


                My.Computer.FileSystem.DeleteFile(upa15)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_c4.mdl", upa15)
                My.Computer.FileSystem.DeleteFile(upa16)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_c4.mdl", upa16)
                My.Computer.FileSystem.DeleteFile(upa17)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_c4.mdl", upa17)

                My.Computer.FileSystem.DeleteFile(upa18)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_aug.mdl", upa18)
                My.Computer.FileSystem.DeleteFile(upa19)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_aug.mdl", upa19)
                My.Computer.FileSystem.DeleteFile(upa20)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_aug.mdl", upa20)


                My.Computer.FileSystem.DeleteFile(upa21)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_deagle.mdl", upa21)
                My.Computer.FileSystem.DeleteFile(upa22)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_deagle.mdl", upa22)
                My.Computer.FileSystem.DeleteFile(upa23)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_deagle.mdl", upa23)

                My.Computer.FileSystem.DeleteFile(upa24)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_usp.mdl", upa24)
                My.Computer.FileSystem.DeleteFile(upa25)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_usp.mdl", upa25)
                My.Computer.FileSystem.DeleteFile(upa26)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_usp.mdl", upa26)


                My.Computer.FileSystem.DeleteFile(upa27)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_glock18.mdl", upa27)
                My.Computer.FileSystem.DeleteFile(upa28)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_glock18.mdl", upa28)
                My.Computer.FileSystem.DeleteFile(upa29)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_glock18.mdl", upa29)


                My.Computer.FileSystem.DeleteFile(upa30)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_elite.mdl", upa30)
                My.Computer.FileSystem.DeleteFile(upa31)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_elite.mdl", upa31)
                My.Computer.FileSystem.DeleteFile(upa32)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_elite.mdl", upa32)


                My.Computer.FileSystem.DeleteFile(upa33)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_famas.mdl", upa33)
                My.Computer.FileSystem.DeleteFile(upa34)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_famas.mdl", upa34)
                My.Computer.FileSystem.DeleteFile(upa35)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_famas.mdl", upa35)

                My.Computer.FileSystem.DeleteFile(upa36)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_fiveseven.mdl", upa36)
                My.Computer.FileSystem.DeleteFile(upa37)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_fiveseven.mdl", upa37)
                My.Computer.FileSystem.DeleteFile(upa38)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_fiveseven.mdl", upa38)


                My.Computer.FileSystem.DeleteFile(upa39)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_flashbang.mdl", upa39)
                My.Computer.FileSystem.DeleteFile(upa40)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_flashbang.mdl", upa40)
                My.Computer.FileSystem.DeleteFile(upa40x)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_flashbang.mdl", upa40x)

                My.Computer.FileSystem.DeleteFile(upa42)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_g3sg1.mdl", upa42)
                My.Computer.FileSystem.DeleteFile(upa43)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_g3sg1.mdl", upa43)
                My.Computer.FileSystem.DeleteFile(upa44)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_g3sg1.mdl", upa44)


                My.Computer.FileSystem.DeleteFile(upa45)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_galil.mdl", upa45)
                My.Computer.FileSystem.DeleteFile(upa46)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_galil.mdl", upa46)
                My.Computer.FileSystem.DeleteFile(upa47)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_galil.mdl", upa47)

                My.Computer.FileSystem.DeleteFile(upax1)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_hegrenade.mdl", upax1)
                My.Computer.FileSystem.DeleteFile(upa48)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_hegrenade.mdl", upa48)
                My.Computer.FileSystem.DeleteFile(upa49)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_hegrenade.mdl", upa49)


                My.Computer.FileSystem.DeleteFile(upa50)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_knife.mdl", upa50)
                My.Computer.FileSystem.DeleteFile(upa52)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_knife.mdl", upa52)
                My.Computer.FileSystem.DeleteFile(upa53)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_knife.mdl", upa53)

                My.Computer.FileSystem.DeleteFile(upa54)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_m3.mdl", upa54)
                My.Computer.FileSystem.DeleteFile(upa55)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_m3.mdl", upa55)
                My.Computer.FileSystem.DeleteFile(upa56)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_m3.mdl", upa56)


                My.Computer.FileSystem.DeleteFile(upa57)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_m249.mdl", upa57)
                My.Computer.FileSystem.DeleteFile(upa58)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_m249.mdl", upa58)
                My.Computer.FileSystem.DeleteFile(upa59)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_m249.mdl", upa59)

                My.Computer.FileSystem.DeleteFile(upa60)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_mac10.mdl", upa60)
                My.Computer.FileSystem.DeleteFile(upa61)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_mac10.mdl", upa61)
                My.Computer.FileSystem.DeleteFile(upa62)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_mac10.mdl", upa62)


                My.Computer.FileSystem.DeleteFile(upa63)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_mp5.mdl", upa63)
                My.Computer.FileSystem.DeleteFile(upa64)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_mp5.mdl", upa64)
                My.Computer.FileSystem.DeleteFile(upa65)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_mp5.mdl", upa65)

                My.Computer.FileSystem.DeleteFile(upa66)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_p90.mdl", upa66)
                My.Computer.FileSystem.DeleteFile(upa67)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_p90.mdl", upa67)
                My.Computer.FileSystem.DeleteFile(upa68)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_p90.mdl", upa68)


                My.Computer.FileSystem.DeleteFile(upa69)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_p228.mdl", upa69)
                My.Computer.FileSystem.DeleteFile(upa70)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_p228.mdl", upa70)
                My.Computer.FileSystem.DeleteFile(upa71)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_p228.mdl", upa71)

                My.Computer.FileSystem.DeleteFile(upa72)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_scout.mdl", upa72)
                My.Computer.FileSystem.DeleteFile(upa73)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_scout.mdl", upa73)
                My.Computer.FileSystem.DeleteFile(upa77)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_scout.mdl", upa77)


                My.Computer.FileSystem.DeleteFile(upa78)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_sg550.mdl", upa78)
                My.Computer.FileSystem.DeleteFile(upa79)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_sg550.mdl", upa79)
                My.Computer.FileSystem.DeleteFile(upa80)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_sg550.mdl", upa80)

                My.Computer.FileSystem.DeleteFile(upa81)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_sg552.mdl", upa81)
                My.Computer.FileSystem.DeleteFile(upa82)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_sg552.mdl", upa82)
                My.Computer.FileSystem.DeleteFile(upa83)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_sg552.mdl", upa83)



                My.Computer.FileSystem.DeleteFile(upa85)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_shield.mdl", upa85)
                My.Computer.FileSystem.DeleteFile(upa86)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_shield.mdl", upa86)

                My.Computer.FileSystem.DeleteFile(upa87)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_smokegrenade.mdl", upa87)
                My.Computer.FileSystem.DeleteFile(upa88)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_smokegrenade.mdl", upa88)
                My.Computer.FileSystem.DeleteFile(upa89)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_smokegrenade.mdl", upa89)


                My.Computer.FileSystem.DeleteFile(upa90)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_tmp.mdl", upa90)
                My.Computer.FileSystem.DeleteFile(upa90x)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_tmp.mdl", upa90x)
                My.Computer.FileSystem.DeleteFile(upa92)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_tmp.mdl", upa92)

                My.Computer.FileSystem.DeleteFile(upa93)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_ump45.mdl", upa93)
                My.Computer.FileSystem.DeleteFile(upa94)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_ump45.mdl", upa94)
                My.Computer.FileSystem.DeleteFile(upa95)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_ump45.mdl", upa95)


                My.Computer.FileSystem.DeleteFile(upa96)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/v_xm1014.mdl", upa96)
                My.Computer.FileSystem.DeleteFile(upa97)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/p_xm1014.mdl", upa97)
                My.Computer.FileSystem.DeleteFile(upa98)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/w_xm1014.mdl", upa98)


                My.Computer.FileSystem.DeleteFile(upa99)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/hostage.mdl", upa99)
                My.Computer.FileSystem.DeleteFile(upa100)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/player.mdl", upa100)

                My.Computer.FileSystem.DeleteFile(upaa3)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/chick.mdl", upaa3)

                My.Computer.FileSystem.DeleteFile(upaa4)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/pshell.mdl", upaa4)
                My.Computer.FileSystem.DeleteFile(upaa5)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/rshell.mdl", upaa5)
                My.Computer.FileSystem.DeleteFile(upaa6)
                My.Computer.Network.DownloadFile("http://skillartzhdrussian.allalla.com/local2/rshell_big.mdl", upaa6)

                MsgBox("FPS Models installed successfully", MsgBoxStyle.Information, "HLDS-PROJECT")
                StartClient.Show()
                Close()
            Else
    ...
    Private Sub NsButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BUTTONNO.Click
        Close()
    End Sub
    ...
    Private Sub Panel1_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles BARAWINDOWS.MouseDown
        X = Control.MousePosition.X - Me.Location.X
        Y = Control.MousePosition.Y - Me.Location.Y
    End Sub
    Private Sub Panel1_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles BARAWINDOWS.MouseMove
